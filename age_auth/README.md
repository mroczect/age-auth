...
[![Crates.io](https://img.shields.io/crates/v/age-auth)](https://crates.io/crates/age-auth)
[![docs.rs](https://docs.rs/age-auth/badge.svg)](https://docs.rs/age-auth)
...
```
age-auth                   (root crate, re-exports everything)
...
You can also depend on the individual crates if you only need part of the
functionality (e.g. just `libage_otp` for OTP generation without encryption).
...
This single dependency brings in all the components you need.
